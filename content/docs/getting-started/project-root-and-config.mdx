...
`sourceRoots` decides which paths are indexed and helps `get_project_structure` show source roots before sibling directories. Structure and source reads still work across the whole project root.
